    ...
    <main>
        ...
        <section>
            ...
            $descricao =
                [
                    ...
                    "Este curso possui suporte diretamente com um profissional
                    da nossa equipe oficial",
                    "A modularização que você precisa para compreender de maneira
                    mais objetiva",
                    "Ao concluir o curso você receberá um certificado Federal
                    com reconhecimento em todo o território nacional",
            ...
            <section>
                ...
                <article>
                    <header>
                        <h3>Aline Figueiredo de Araújo (Ponto Positivo)</h3>
                        <p>
                            O CURSO VISA CAPACAPACITAÇÃO PARA ATUAÇÃO EM UMA
                ...
                <article>
                    <header>
                        ...
                        <p>
                            ...
                            ENCONTRARÁ DIFICULDADES NO INICIO
                        </p>
                    </header>
                </article>
                ...
                <article>
                    <header>
                        ...
                        <p>É GRATUITO, E TAMBÉM À DISTÂNCIA</p>
                    </header>
                </article>
        ...
        <section>
            ...
            <article>
                ...
                <p>
                    Que tal estudar conosco e aprender a como entregar seus
                    projetos utilizando HTML5 e CSS3 com boas práticas?
                </p>
            </article>
        ...
        <section>
            ...
            <article>
                ...
                <p>
                    Como muitos, comecei na programação por curiosidade! Com
                    o tempo, o amor pela programação foi crescendo a ponto
                    de se tornar uma profissão e me especializar na área.
                    Hoje, com a bagagem que tenho, compartilho meu
                    conhecimento com todos os alunos que estudam no
                    <i>Campus</i> Araguaína - IFTO
                </p>
            </article>
            <section>
                <header>
