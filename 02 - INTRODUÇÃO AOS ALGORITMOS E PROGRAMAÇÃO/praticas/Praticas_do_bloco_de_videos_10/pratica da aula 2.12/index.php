...
array_unshift($index, "", "FULL CYCLE DEVELOPER");   //adiciona valores no inicio do vetor
...
asort($index);  // Ordena seguindo a ordem alfabética do conteúdo.
asort($assoc);  // Ordena seguindo a ordem alfabética do conteúdo.

ksort($index);  // Ordena de acordo com o indice.
ksort($assoc);  // Ordena de acordo com o indice.

sort($index);  // ordena seguindo o valor
...
$arrToString = implode(", ", $assoc);    //extrai os valores e coloca dentro do arrTostring
...
$profile = [
    "name" => "Raphael",
    "company" => "Residência",
    "mail" => "raphaelaraujotoc@outlook.com"
];
